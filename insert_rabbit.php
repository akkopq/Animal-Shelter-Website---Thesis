...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO rabbits (pet_name, age, sex, breed, size, hair_length, image_path) 
            VALUES ('$pet_name', '$age', '$sex', '$breed', '$size', '$hair_length', '$image_path')";

     if (mysqli_query($conn, $sql)) {
        echo "<p>New rabbit added successfully. You will be redirected to the database manager in 5 seconds.</p>";
