...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO birds (pet_name, species, sex, size, image_path) 
            VALUES ('$pet_name', '$species', '$sex', '$size', '$image_path')";

      if (mysqli_query($conn, $sql)) {
        echo "<p>New bird added successfully. You will be redirected to the database manager in 5 seconds.</p>";
