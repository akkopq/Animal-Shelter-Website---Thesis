...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO dogs (pet_name, age, sex, breed, size, color, spayed, vaccinated, special_needs, image_path) 
            VALUES ('$pet_name', '$age', '$sex', '$breed', '$size', '$color', '$spayed', '$vaccinated', '$special_needs', '$image_path')";

     if (mysqli_query($conn, $sql)) {
        echo "<p>New dog added successfully. You will be redirected to the database manager in 5 seconds.</p>";
